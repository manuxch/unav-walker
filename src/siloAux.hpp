 ...
 * \param size_t* : bin_count array que registra los bines no nulos para las velocidades
 * \param int : n_bins número de bins que divide el orificio de salida
 * \param double : r_out radio del orificio de salida
 * */
void update_pf_vx(b2World *w, double *vel_0, size_t *pf_0, size_t *bin_count, int n_bins, double r_out);
